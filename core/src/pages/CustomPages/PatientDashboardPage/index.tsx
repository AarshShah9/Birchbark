        ...
        <div className='w-full h-screen bg-blue-500 flex flex-row'>
            <div className='w-1/6 2xl:w-1/4 sm:w-1/3 h-screen bg-[#141718]'>
                ...
                <div className=' flex flex-col'>
                    <a 
                        href='#' 
                        className='h-20 py-4 space-x-[22px] flex items-center justify-center bg-[#4CA9EE]'
                    >
                        <motion.div 
            ...
            {/* Right Side */}
            <div className='bg-[#232627] w-5/6 2xl:w-3/4 sm:w-2/3 h-fit py-12 px-10'>
                {/* Top Bar */}
                <div className='flex justify-between flex-row'>
                    ...
                    <div className='flex flex-row space-x-4'>
                        ...
                        <motion.a
                            href='#' 
                            className='bg-[#4CA9EE] w-14 h-14 rounded-full'
                            whileHover={{ scale: 1.1 }}
                        >
