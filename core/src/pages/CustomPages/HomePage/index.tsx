...
const HomePage: React.FC = () => {
  return (
    <div>
                    ...
                    <div className='h-full flex justify-between '>
                        <div className='flex justify-center items-center w-full h-full '>
                            <div>
                                ...
                                <div>
                                <motion.a whileHover={{ scale: 1.1, backgroundColor: '#045de9'}} className='w-48 lg:w-36 h-14 lg:h-10 my-6 lg:my-4 rounded-full flex justify-center items-center bg-blue-500' href='/CustomPages/PricingPage'><span className='text-center font-bold text-2xl lg:text-xl'>See Pricing</span></motion.a>
                                </div>
                            </div>
                        </div>
        ...
        {/* Blue Waves */}
        <div className='w-full relative bg-[#141718]'>
