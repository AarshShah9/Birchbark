...
const ImagesPage: NextPage = () => {
    return <Layout><ImageLibrary/></Layout>;
};
    ...
    return (
        <>
            ...
            <div className="relative min-h-[10%] border-b border-n-3 dark:border-n-6">
                ...
                <input
                    className="h5 h-22 w-full border-none bg-transparent pl-24 pr-5 text-n-7 outline-none placeholder:text-n-4/50 dark:text-n-1 md:h-18 md:pl-18 text-white"
                    type="text"
                    name="search"
            ...
            {copied && (
                <div className="bg-green-500 text-white p-2 rounded-md absolute top-5 right-5 z-10">
                    Copied To Clipboard
                </div>
            )}
