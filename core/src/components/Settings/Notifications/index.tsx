...
const Notifications = ({}: NotificationsProps) => {
  ...
  const handleNotificationsChange = (value: boolean) => {
    ...
    const updatedCheckboxes = [...checkboxes];
    for (const group of updatedCheckboxes) {
      for (const checkbox of group.checkboxs) {
  ...
  return (
    <form className="" action="" onSubmit={() => console.log("Submit")}>
      <div className="mb-8 flex items-center">
        <div className="h4 mr-auto">Notifications</div>
      ...
      <div>
        {checkboxes.map((group) => (
          <div
            ...
            key={group.id}
          >
            <div className="h6 mb-4">{group.title}</div>
