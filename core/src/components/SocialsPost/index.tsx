...
const SocialsPost = ({ items }: SocialsPostProps) => (
  <div className="">
    <div>
      Here&apos;s an example of promotional content optimized for Twitter and
      Facebook:
    </div>
    <div className="mt-5">
      {items.map((x) => (
    ...
    <div className="mt-5">
      ...
      <div className="-ml-4 -mt-4 flex flex-wrap md:ml-0 md:block">
        <button className="btn-dark btn-medium ml-4 mt-4 rounded-md px-4 md:ml-0 md:w-full">
          <span>Add to Queue</span>
          <Icon name="share" />
        </button>
        <button className="btn-white btn-medium ml-4 mt-4 rounded-md px-4 md:ml-0 md:w-full">
          <span>Share now</span>
          <Icon name="share-1" />
        </button>
        <button className="btn-white btn-medium ml-4 mt-4 rounded-md px-4 md:ml-0 md:w-full">
