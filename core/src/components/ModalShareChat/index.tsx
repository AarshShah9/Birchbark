...
const ModalShareChat = ({ visible, onClose }: ModalShareChatProps) => {
  ...
  const onCopy = () => {
    ...
    toast((t) => (
      <Notify iconCheck>
        <div className="h6 ml-3">Link copied</div>
      </Notify>
    ));
  };
  ...
  return (
    ...
    >
      ...
      >
        <div className="h4 mb-8">Share this chat</div>
        <div className="base2 mb-4 font-semibold text-n-6 dark:text-n-3">
          Copy link
        </div>
        <div className="relative mb-8">
          ...
          <CopyToClipboard text={link} onCopy={onCopy}>
            <button
              className="btn-dark absolute right-1 top-1"
              ref={copyButtonRef}
              type="button"
            >
              Copy
