    ...
    const ConfirmModal = () => {
        return (
            ...
            >
                ...
                <Dialog.Panel className={"px-20 pt-2 pb-8"}>
                    <div className='flex flex-row justify-between'>
                        ...
                        <div className='flex flex-col justify-center mr-4'>
                            ...
                            <div className='text-right text-md'>{duration} Minutes</div>
                        </div>
                    </div>
                </Dialog.Panel>
                <div className='flex justify-center items-center'>
                ...
                <div className='flex justify-center items-center'>
                    ...
                    <motion.button 
                        ...
                        onClick={() => {
                            ...
                            returnEndTime.setUTCMinutes(returnStartTime.getUTCMinutes() + duration);
